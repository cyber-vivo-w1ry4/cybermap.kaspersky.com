...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  https://bugshunters.google.com -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
